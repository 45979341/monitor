 ...
 **/
@Data
@Document(indexName = "realtime_info",type = "doc")
public class MonitorRealtimeInfo implements Serializable {
    ...
    public static void main(String[] args) {
        MonitorRealtimeInfo monitorRealtimeInfo = new MonitorRealtimeInfo();
        Class<? extends MonitorRealtimeInfo> clazz = monitorRealtimeInfo.getClass();
        Field[] fileds = clazz.getDeclaredFields();
        for (Field f : fileds) {
            f.setAccessible(true);
            String name = f.getName();
            String s = StringUtils.camelToUnderline(name);
