...
import com.zhuzhou.framework.utils.jdbc.SpecUtils;
...
public class BaseServiceImpl<M extends BaseMapper<T>, T> implements BaseService<T> {
    ...
    public boolean removeAll () {
        return SqlHelper.delBool(baseMapper.delete(null));
    }
    ...
    @Override
    public T getOne(Form<T> form) {
        QueryWrapper<T> qw = SpecUtils.condition(form);
        if (qw == null) {
            qw = new QueryWrapper<>();
        }
        return SqlHelper.getObject(baseMapper.selectList(qw));
    }
    ...
    @Override
    public List<T> list(Form<T> form) {
        QueryWrapper<T> qw = SpecUtils.condition(form);
        if (qw == null) {
            qw = new QueryWrapper<>();
        }
        SpecUtils.pageable(qw, form);
    ...
    @Override
    public IPage<T> pageForm(Form<T> form) {
        Wrapper<T> qw = SpecUtils.condition(form);
        Page<T> page = SpecUtils.pageable(form);
        if (qw == null) {
